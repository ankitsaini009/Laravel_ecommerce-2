...
<div class="col-12">
    <div class="card">
        <h3 class="card-header">City Add Form*</h3>
        <div class="card-body">

            <form id="formValidationExamples" action="{{route('City.store')}}" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"
       ...
       <!-- Account Details -->
                ...
                <div class="col-md-6">
                    ...
                    <select name="State" class="form-control">
                      ...
                      <option value="{{$get->id}}">{{$get->state_name}}</option>
                      @endforeach
                    </select>
