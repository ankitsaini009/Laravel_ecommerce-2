...
<div class="col-12">
    <div class="card">
        <h3 class="card-header">Country Edit Form*</h3>
        <div class="card-body">

            <form id="formValidationExamples" action="{{route('Country.update', $getcolor->id)}}"
                ...
                <div class="col-md-6 fv-plugins-icon-container">
                    ...
                    <input type="text" id="name" class="form-control" placeholder="Please Enter Name"
                        name="name" value="{{$getcolor->countries_name}}">
                    @error('name')
