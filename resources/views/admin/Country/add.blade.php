...
<div class="col-12">
    <div class="card">
        <h3 class="card-header">Country Add Form*</h3>
        <div class="card-body">

            <form id="formValidationExamples" action="{{route('Country.store')}}" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"
