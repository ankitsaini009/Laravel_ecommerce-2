...
<div class="col-12">
    <div class="card">
        <h3 class="card-header">Page Add Form*</h3>
        <div class="card-body">

            <form id="formValidationExamples" action="{{route('Page.store')}}" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"
                ...
                <div class="col-md-6 fv-plugins-icon-container">
                    ...
                    <textarea class="form-control" id="formValidationBio" name="description" rows="3"></textarea>
                    @error('description')
                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                        {{ $message }}
                    </div>
