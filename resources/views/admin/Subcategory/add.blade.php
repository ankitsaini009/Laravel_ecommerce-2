...
<div class="col-12">
    <div class="card">
        <h3 class="card-header">Subcategory Add Form*</h3>
        <div class="card-body">

            <form id="formValidationExamples" action="{{route('Subcategory.store')}}" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"
       ...
       <!-- Account Details -->
                ...
                <div class="col-md-6">
                    <label for="inputEmail3" name="menu" class="col-sm-3 col-form-label">Select Category</label>
                    <select name="category" class="form-control">
                      <option value="">Select categry</option>
                      @foreach($getcategory as $get)
                ...
                <div class="col-md-6 fv-plugins-icon-container">
                    ...
                    <input class="form-control" type="file" id="category_image" name="subcategory_image">
