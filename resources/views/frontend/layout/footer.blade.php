                ...
                <table id="product-table" class="product-table">
                    ...
                    <tbody>
                        <tr class="tr-image">
                            ...
                            <td>
                                <a href="shop-details.html">
                                    <img width="600" height="600" src="{{url('media/product/1.jpg')}}" alt="">
                                </a>
                            </td>
                            <td>
                                <a href="shop-details.html">
                                    <img width="600" height="600" src="{{url('media/product/2.jpg')}}" alt="">
                                </a>
                            </td>
                        </tr>
                        <tr class="tr-sku">
                                        ...
                                        <div class="slick-wrap">
                                            <div class="slick-sliders image-additional" data-dots="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
                                                <div class="img-thumbnail slick-slide"> 
                                                    <a href="{{url('media/product/3.jpg')}}" class="image-scroll" title="">
                                                        <img width="900" height="900" src="{{url('media/product/3.jpg')}}" alt="">
                                                    </a> 
                                                </div>
                                                <div class="img-thumbnail slick-slide"> 
                                                    <a href="{{url('media/product/3-2.jpg')}}" class="image-scroll" title="">
                                                        <img width="900" height="900" src="{{url('media/product/3-2.jpg')}}" alt="">
                                                    </a> 
                                                </div>
                                            </div>
                                        </div>
...
<!-- Dependency Scripts -->
<script src="{{url('libs/popper/js/popper.min.js')}}"></script>
<script src="{{url('libs/jquery/js/jquery.min.js')}}"></script>
<script src="{{url('libs/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{url('libs/slick/js/slick.min.js')}}"></script>
<script src="{{url('libs/mmenu/js/jquery.mmenu.all.min.js')}}"></script>
<script src="{{url('libs/slider/js/tmpl.js')}}"></script>
<script src="{{url('libs/slider/js/jquery.dependClass-0.1.js')}}"></script>
<script src="{{url('libs/slider/js/draggable-0.1.js')}}"></script>
<script src="{{url('libs/slider/js/jquery.slider.js')}}"></script>
...
<!-- Mirrored from caketheme.com/html/mojuri/shop-grid-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 09:32:06 GMT -->
</html>