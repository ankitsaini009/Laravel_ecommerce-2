...
<!-- Mirrored from caketheme.com/html/mojuri/shop-grid-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 09:32:02 GMT -->
<head>
		<!-- Meta Data -->
		<meta charset="UTF-8">
		...
		<!-- Favicon -->
		<link rel="" type="image/x-icon" href="{{url('media/favicon.png')}}">
...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
		...
		<link rel="stylesheet" href="{{url('libs/slider/css/jslider.css')}}">
		<!-- Site Stylesheet -->								
						...
						<div class="section-container">
							<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 header-center">
									<div class="site-logo">
										<a href="index-2.html">
											<img width="400" height="79" src="{{url('media/logo-white.png')}}" alt="Mojuri  Jewelry Store HTML Template" />
										</a>
									</div>
								</div>
												...
												<div class="cart-list-wrap">
													<ul class="cart-list ">
														<li class="mini-cart-item">
															...
															<a href="shop-details.html" class="product-image"><img width="600" height="600" src="{{url('media/product/3.jpg')}}" alt=""></a>
														...
														<li class="mini-cart-item">
															<a href="#" class="remove" title="Remove this item"><i class="icon_close"></i></a>													
															<a href="shop-details.html" class="product-image"><img width="600" height="600" src="{{url('media/product/1.jpg')}}" alt=""></a>
													...
													<div class="buttons">
														<a href="frontend.cart" class="button btn view-cart btn-primary">View cart</a>
														<a href="chekout" class="button btn checkout btn-default">Check out</a>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="section-container large p-l-r">
								<div class="row">
									<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-left">
										<div class="site-logo">
											<a href="index-2.html">
												<img width="400" height="140" src="{{url('media/logo.png')}}" alt="Mojuri  Jewelry Store HTML Template" />
											</a>
										</div>
									</div>
											...
											<nav id="main-navigation">
												<ul id="menu-main-menu" class="menu">
													<li class="level-0 menu-item menu-item-has-children current-menu-item">
														<a href="index-2.html"><span class="menu-item-text">Home</span></a>
														<ul class="sub-menu">
															<li>
																<a href="index-2.html"><span class="menu-item-text">Home Clean</span></a>
															</li>
															<li>
													...
													<li class="level-0 menu-item menu-item-has-children">
														...
														<ul class="sub-menu">
															<li>
																<a href=""><span class="menu-item-text">Login / Register</span></a>
															</li>
															<li>
													...
													<div class="dropdown-menu cart-popup">
														...
														<div class="cart-list-wrap">
															<ul class="cart-list ">
																...
																$totalqty = 0;
																$totalamount = 0;
																$cart = \App\helper\helper::getUserCart();
																@endphp
																@if(count($cart)>0)
																@foreach($cart as $cartdata)
																@php
																$productprice = $cartdata->products->mrp_price * $cartdata->qty;
																$totalqty += $cartdata->qty;
																$totalamount += $productprice;
																@endphp
																<li class="mini-cart-item">
																	<a href="#" class="remove" title="Remove this item"><i class="icon_close"></i></a>													
																	<a href="shop-details.html" class="product-image"><img width="600" height="600" src="{{ asset('uploads/banners/'.$cartdata->products->main_image) }}" alt=""></a>
																	<a href="shop-details.html" class="product-name">{{$cartdata->products->name}}</a>
																	<div class="quantity">{{$cartdata->qty}}</div>
																	<div class="price">{{\App\helper\helper::displayPrice($cartdata->products->mrp_price * $cartdata->qty) }}</div>						
																</li>
																@endforeach
															</ul>
															<div class="total-cart">
																<div class="title-total">{{\App\helper\helper::displayPrice($totalamount)}}: </div>
															...
															<div class="buttons">
																<a href="{{route('frontend.cart')}}" class="button btn view-cart btn-primary">View cart</a>
																<a href="{{route(('frontend.chekout'))}}" class="button btn checkout btn-default">Check out</a>
															</div>
															  @endif
														</div>
													</div>
